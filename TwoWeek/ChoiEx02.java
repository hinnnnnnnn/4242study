...
public class ChoiEx02 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i<number.length-1; i++) {//배열의 i번째 숫자와 i+1번째 숫자를 비교하여가장 큰 숫자가 마지막 순서로 이동할 수 있도록 하는 부분입니다.
            for (int j = 0; j<number.length-1-i; j++) { //배열의 j번째 숫자와 j+1번째 숫자를 비교하여 가장 큰 숫자가 마지막 순서로 이동할 수 있도록 하는 부분입니다.
