...
//                break;
//                case "Meet": //[문제1]"Meet"문구 입력시, MeetPizza() 호출
//                break;
...
//    @Override
//    { //[문제2]객체가 가지고 있는 정보나 값들을 문자열로 만들어 리턴하는 메서드, object 클래스의 toString 메서드 오버라이딩
//        return  ", 불고기"; //[문제3]값 리턴 (상속받은 BasicPizza 리턴 값 + 새로 리턴한 값 출력)
//    }
//}
//class CheezePizza extends MeatPizza{
//    @Override
//   { //[문제2]객체가 가지고 있는 정보나 값들을 문자열로 만들어 리턴하는 메서드, object 클래스의 toString 메서드 오버라이딩
//        return ", 치즈 2배"; //[문제3]값 리턴 (상속받은 BasicPizza 리턴 값 + 새로 리턴한 값 출력)
//    }
//}
//class PineApplePizza extends BasicPizza {
//    @Override
//    { //[문제2]객체가 가지고 있는 정보나 값들을 문자열로 만들어 리턴하는 메서드, object 클래스의 toString 메서드 오버라이딩
//        return ", 파인애플, 양송이버섯"; //[문제3]값 리턴 (상속받은 BasicPizza 리턴 값 + 새로 리턴한 값 출력)
//    }
//}
//class PotatoPizza extends BasicPizza {
//    @Override
//    //[문제2]객체가 가지고 있는 정보나 값들을 문자열로 만들어 리턴하는 메서드, object 클래스의 toString 메서드 오버라이딩
//        return  ", 감자, 마요네즈, 베이컨"; //[문제3]값 리턴 (상속받은 BasicPizza 리턴 값 + 새로 리턴한 값 출력)
//    }
//}
//
