/*상속문제 - 윤아aovie클래스에 감독,배우 평점을 입력하여 영화 총점을 계산하고 영화 평점을 출력한 후
...
void display() {
	...
	System.out.printf("영화제목:"+title+"\n");
	System.out.printf("감독:"+director);
	System.out.printf(",베우:"+actor+"\n");
	System.out.printf("영화총점:"+total+"\n");
	if(total>=17)
		result="☆☆☆☆☆";
		else if(total>=15)
			result="☆☆☆☆";
...
class MovieWork extends Movie {
	...
	//[문제5]main에서 MovieWork클래스에 영화제목,감독과배우,작품성,대중성,대본 평점,영화총점이 입력되어 출력될 수 있도록 코딩하기(힌트:printf사용하기)
		...
		System.out.printf("감독:"+director);
		System.out.printf(",베우:"+actor);
		System.out.printf(",작품성:"+cinematic);
		System.out.printf(",대중성:"+popular);
		System.out.printf(",시나리오:"+scenario+"\n");
		System.out.printf("영화총점:"+total+"\n");
