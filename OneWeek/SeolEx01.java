...
//2.윤아의 현재 성적이 주어진다.해당 값은 100보다 작거나 같은 음이 아닌 정수이고, 적어도 1개의 값은 0보다 커야한다.
        ...
        public static void main(String[] args) {
            ...
            //[문제1]윤아의 과목별 성적을 담기 위해 배열 array선언하기
            ...
            long Max = array[0]; //최댓값은 for문을 이용하여 인덱스끼리 비교해야하므로 0으로 초기화함

            for(int i=0; i<array.length; i++) {
                if(Max<array[i]) {
                    Max = array[i];
                    System.out.println("가장 큰 점수는 : " + Max);
                }

                //[문제2]조건문을을 활용해 인덱스끼리 비교하여 Max값을 구하는 코드 작성하기
            ...
            double avg = sum/N;
            System.out.println("조작된 점수의 평균은 : " + avg);
