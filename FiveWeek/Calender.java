...
public class Calender {
    ...
    public static void main(String[] args) {
        ...
        int yoil[] = computeyoil(year); //1년 1월1일 은 월요일

        switch (yoil[0]) // SUN:0 MON:1 TUE:2 WED:3 THU:4 FRI:5 SAT:6
        {
            case 0:
                System.out.println(year+"년 1월 1일은 일요일");
                break;
            case 1:
                System.out.println(year+"년 1월 1일은 월요일");
                break;
            case 2:
                System.out.println(year+"년 1월 1일은 화요일");
                break;
            case 3:
                System.out.println(year+"년 1월 1일은 수요일");
                break;
            case 4:
                System.out.println(year+"년 1월 1일은 목요일");
                break;
            case 5:
                System.out.println(year+"년 1월 1일은 금요일");
                break;
            case 6:
                System.out.println(year+"년 1월 1일은 토요일");
                break;
        }

        printCalendar(year,yoil);
        in.close();
    }
