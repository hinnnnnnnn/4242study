        ...
        public static void main(String[] args) {
            ...
            while (true){
                ...
                if(choice==1){
                    ...
                    String date = sc.nextLine();//사용자가 입력한 날짜를 저장합니다.
                    System.out.print("일정 내용을 입력하세요.>>");
                    String searchEvent = sc.nextLine();//사용자가 입력한 일정을 저장합니다.
                    ...
                    String date1 = sc.nextLine();//사용자가 입력한 검색할 날짜를 저장합니다.
                    calender.get(date1);
                    String searchEvent = calender.get(date1);
                    ...
                    if(searchEvent!=null){ //해쉬맵 calender에 입력한 날짜와 일치하는 일정 내용이 있다면
                        ...
                        System.out.println(date1+"의 일정은 "+searchEvent+"입니다.");
                        System.out.println("\n");
                    }
